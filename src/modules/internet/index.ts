...
export class InternetModule {
  ...
  password(
    ...
    while (chars.length < options.length) {
      const groupIndex = this.faker.number.int(charGroups.length - 1);

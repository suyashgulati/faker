...
function spliceElement<T>(array: T[], element: T): void {
...
function removeTsSuffix(files: ReadonlyArray<string>): string[] {
...
function generateLocalesIndexFile(
  ...
  spliceElement(modules, 'index.ts');
...
function generateRecursiveModuleIndexes(
  ...
  spliceElement(submodules, 'index.ts');
...
spliceElement(locales, 'index.ts');
spliceElement(locales, 'all.ts');
